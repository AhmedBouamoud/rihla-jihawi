...
const EXPLORATION_DATA = {
  ...
  station2: {
    type: 'dragzone',
    title: 'خريطة الدليل',
    instructions: 'اسحب كل عنصر إلى خانته الصحيحة: هل هو سبب، مظهر، أم نتيجة؟',
    zones: ['سبب', 'مظهر', 'نتيجة'],
    items: [
      { id: 'i1', text: 'البحث عن فرص الشغل', zone: 'سبب' },
      { id: 'i2', text: 'ضعف التجهيزات بالبوادي', zone: 'سبب' },
      { id: 'i3', text: 'نمو الأحياء الهامشية', zone: 'مظهر' },
      { id: 'i4', text: 'ارتفاع الكثافة السكانية بالمدن', zone: 'مظهر' },
      { id: 'i5', text: 'اكتظاظ المدن الكبرى', zone: 'نتيجة' },
      { id: 'i6', text: 'تفاقم أزمة السكن', zone: 'نتيجة' }
    ],
  ...
  station3: {
    ...
    items: [
      ...
      { id: 'c5', text: 'البيئة', zone: 'الجغرافيا' },
      { id: 'c6', text: 'التراث', zone: 'المواطنة' }
    ],
