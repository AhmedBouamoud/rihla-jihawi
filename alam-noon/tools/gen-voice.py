...
PHRASES = {
  ...
  # ============ النسخة المتطورة: نهر الحروف، ورشة الكلمات، ألبوم الأرواح ============
  'intro-station6': 'وَصَلْنَا نَهْرَ الحُرُوف! حُرُوفٌ صَغِيرَةٌ تَسْبَحُ فِي المَاء. اِنْظُرْ إِلَى الحَرْفِ المَطْلُوبِ فَوْقَ النَّهْر، وَاصْطَدْهُ بِلَمْسِهِ قَبْلَ أَنْ يَهْرُب!',
  'intro-station7': 'هَذِهِ وَرْشَةُ الكَلِمَات! اِضْغَطِ الحُرُوفَ بِالتَّرْتِيبِ الصَّحِيحِ لِتَطِيرَ إِلَى أَمَاكِنِهَا، فَتَصْنَعَ الآلَةُ كَلِمَةً جَدِيدَة.',
  'intro-spirits':  'هَذَا أَلْبُومُ أَرْوَاحِ الحُرُوف. كُلَّمَا أَكْمَلْتَ مُهِمَّةً تَحَرَّرَتْ رُوحٌ جَدِيدَة. اِضْغَطْ عَلَى أَيِّ رُوحٍ لِتَسْمَعَهَا.',
  'hunt-m': 'اِصْطَدْ ثَلَاثَةَ حُرُوفِ م',
  'hunt-b': 'اِصْطَدْ ثَلَاثَةَ حُرُوفِ ب',
  'hunt-s': 'اِصْطَدْ ثَلَاثَةَ حُرُوفِ س',
  'no6':   'لَيْسَ هَذَا هُوَ الحَرْفُ المَطْلُوب',
  'done6': 'مُدْهِش! نَظَّفْتَ النَّهْرَ مِنَ الحُرُوفِ الضَّائِعَة، وَتَحَرَّرَتْ رُوحُ حَرْفِ سِين!',
  'build-mawz': 'رَكِّبْ كَلِمَةَ مَوْز',
  'build-bab':  'رَكِّبْ كَلِمَةَ بَاب',
  'build-nur':  'رَكِّبْ كَلِمَةَ نُور',
  'made-mawz': 'رَائِع! صَنَعْنَا كَلِمَةَ مَوْز!',
  'made-bab':  'رَائِع! صَنَعْنَا كَلِمَةَ بَاب!',
  'made-nur':  'رَائِع! صَنَعْنَا كَلِمَةَ نُور!',
  'done7': 'عَمَلٌ رَائِع! صَنَعْنَا ثَلَاثَ كَلِمَات، وَتَحَرَّرَتْ رُوحَا حَرْفَيْ رَاء وَوَاو!',
  'sp-m': 'أَنَا رُوحُ حَرْفِ مِيم. مْ... مِثْلَ مَوْز وَمَاء وَمِفْتَاح.',
  'sp-b': 'أَنَا رُوحُ حَرْفِ بَاء. بْ... مِثْلَ بَاب وَبَالُون.',
  'sp-n': 'أَنَا رُوحُ حَرْفِ نُون. نْ... مِثْلَ نَجْمَة وَنُور.',
  'sp-s': 'أَنَا رُوحُ حَرْفِ سِين. سْ... مِثْلَ سَمَكَة وَسَمَاء.',
  'sp-r': 'أَنَا رُوحُ حَرْفِ رَاء. رْ... مِثْلَ رُمَّان وَرِيشَة.',
  'sp-w': 'أَنَا رُوحُ حَرْفِ وَاو. وْ... مِثْلَ وَرْدَة وَوَلَد.',
  'sp-locked': 'أَنَا رُوحٌ نَائِمَة... سَتُوقِظُنِي مُهِمَّاتٌ جَدِيدَةٌ قَرِيبًا!',
  'l-na': 'نَ',
  'l-ra': 'رَ',
  'l-wa': 'وَ',
  'l-za': 'زَ',
