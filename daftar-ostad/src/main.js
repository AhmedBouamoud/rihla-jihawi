...
// export
import { downloadBackup, importBackupFile, downloadJournalCSV, downloadDocsCSV, downloadReportHTML, exportDaftarToWord } from './modules/export.js';

// cloud backup
import { backupToGoogleDrive, restoreFromGoogleDrive, saveGoogleClientId, initCloudBackup } from './modules/cloud.js';
...
function _exportDaftarToWord(){ exportDaftarToWord(header); }
...
Object.assign(window, {
  ...
  downloadDocsCSV,
  downloadReportHTML,
  exportDaftarToWord:  _exportDaftarToWord,
  // cloud backup
  backupToGoogleDrive,
